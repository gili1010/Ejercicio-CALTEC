...
export class MeliPage extends BasePage {
        ...
        async selectVehiculos(){
            ...
            throw new Error(`Error al seleccionar Vehículos: ${error.message}`);
        }    
        }

        private async filtroPrecio(){
                const filtros = {
                ...
                try{
                    ...
                    throw new Error(`Error al aplicar filtro de precio: ${error.message}`);
                }
        }

        private async filtroKm(){
                const filtros = {
                ...
                try{
                    ...
                    throw new Error(`Error al aplicar filtro de kilometraje: ${error.message}`);
                }
        }
